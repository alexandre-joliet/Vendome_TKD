              ...
              <b>2023/2024</b> et l'adresse de notre Dojang.
                    ...
                    <section className={styles.article_section}>
                        ...
                        <div className={styles.cards_container}>
                            <div
                                className={`${styles.card_container} ${styles.children}`}
                            >
                                    ...
                                    <table className={styles.table_price}>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <span>&#11088;</span>
                                                    Passeport (obligatoire 1ère
                                                    année et valable 8 ans)
                                                </td>
                                                <td
                                                    className={
                                                        styles.extra_price
                            ...
                            <div
                                className={`${styles.card_container} ${styles.teens}`}
                            >
                                <div className={styles.card_info}>
                                    <h3 className={styles.info_title}>
                            ...
                            <div
                                className={`${styles.card_container} ${styles.adults}`}
                            >
                                <div className={styles.card_info}>
                                    <h3 className={styles.info_title}>
                                        Adultes
                        ...
                        <section className={styles.section_documents}>
                            ...
                            >
                                ...
                                <button
                                    className={`${styles.expand_toggler} ${toggleClass}`}
                                >
                                    <img
                            ...
                            <div
                                className={`${styles.content_container} ${expandClass}`}
                            >
                                <ul className={styles.documents_list}>
                                    <li>2 photos d'identité</li>
                                    <li>
                                        <a
                                            href="/files/Fiche Inscription Vendôme Taekwondo 2025.pdf"
                                            target="_blank"
                                        >
                                            Fiche d'inscription
                                        </a>{" "}
                                    ...
                                    <li>
                                        ...
                                        attestant de la pratique du Taekwondo
                                    </li>
                                    <li>
                                        Règlement de la cotisation et des frais
                                        annexes (licence et passeport si
                                        applicable)
                                    </li>
                                </ul>
                            </div>
                        ...
                        <section className={styles.section_note}>
                            <div className={styles.note_container}>
                                ...
                                <p className={styles.note_text}>
                                    Pour permettre le repos de tous, et sauf
                                    mention contraire annoncée lors des
                                    entraînements, aucun cours n'a lieu durant
                            ...
                            <div className={styles.note_container}>
                                ...
                                <p className={styles.note_text}>
                                    L'achat de dobok (tenue traditionnelle) ou
                                    d'équipements de protection n'est pas
                                    nécessaire pour débuter la pratique du
                                    Taekwondo. <b>Une tenue de sport</b>{" "}
                                    appropriée suffit !
                                </p>

                                <p className={styles.note_text}>
                                    De plus, nous organisons en début de saison
                                    des commandes groupées avec notre
                                    fournisseur pour équiper ceux qui le
                                    souhaitent tout en bénéficiant de
                                    réductions. Si vous êtes intéressés,
                    ...
                    <div className={styles.bg_wrapper}>
                        <section className={styles.article_section}>
                            ...
                            <p className={styles.location_text}>
                                ...
                                <b>Complexe Sportif d'Arts Martiaux</b> de
                                Vendôme situé au :
                            </p>
                            ...
                            <p className={styles.location_text}>
                                Un parking est à disposition juste à côté du
                                complexe pour stationner.
                            </p>
